...
# 2006
trainData79 <- trainData79 %>% 
  mutate(AGE_START_JOB1_2006 = AGEATINT_R0989000 - TENURE1_T0986300,
         AGE_START_JOB2_2006 = AGEATINT_R0989000 - TENURE2_T0986400,
         AGE_START_JOB3_2006 = AGEATINT_R0989000 - TENURE3_T0986500,
         AGE_START_JOB4_2006 = AGEATINT_R0989000 - TENURE4_T0986600,
         AGE_START_JOB5_2006 = AGEATINT_R0989000 - TENURE5_T0986700)

trainData79 <- trainData79 %>%
  mutate(MEAN_AGE_JOB1_2006 = (AGEATINT_R0989000 + AGE_START_JOB1_2006) / 2,
         MEAN_AGE_JOB2_2006 = (AGEATINT_R0989000 + AGE_START_JOB2_2006) / 2,
         MEAN_AGE_JOB3_2006 = (AGEATINT_R0989000 + AGE_START_JOB3_2006) / 2,
         MEAN_AGE_JOB4_2006 = (AGEATINT_R0989000 + AGE_START_JOB4_2006) / 2,
         MEAN_AGE_JOB5_2006 = (AGEATINT_R0989000 + AGE_START_JOB5_2006) / 2)

# 2008
trainData79 <- trainData79 %>% 
  mutate(AGE_START_JOB1_2008 = AGEATINT_R2210800 - TENURE1_T2208600,
         AGE_START_JOB2_2008 = AGEATINT_R2210800 - TENURE2_T2208700,
         AGE_START_JOB3_2008 = AGEATINT_R2210800 - TENURE3_T2208800,
         AGE_START_JOB4_2008 = AGEATINT_R2210800 - TENURE4_T2208900,
         AGE_START_JOB5_2008 = AGEATINT_R2210800 - TENURE5_T2209000)

trainData79 <- trainData79 %>%
  mutate(MEAN_AGE_JOB1_2008 = (AGEATINT_R2210800 + AGE_START_JOB1_2008) / 2,
         MEAN_AGE_JOB2_2008 = (AGEATINT_R2210800 + AGE_START_JOB2_2008) / 2,
         MEAN_AGE_JOB3_2008 = (AGEATINT_R2210800 + AGE_START_JOB3_2008) / 2,
         MEAN_AGE_JOB4_2008 = (AGEATINT_R2210800 + AGE_START_JOB4_2008) / 2,
         MEAN_AGE_JOB5_2008 = (AGEATINT_R2210800 + AGE_START_JOB5_2008) / 2)

# 2010
trainData79 <- trainData79 %>% 
  mutate(AGE_START_JOB1_2010 = AGEATINT_R3108700 - TENURE1_T3106400,
         AGE_START_JOB2_2010 = AGEATINT_R3108700 - TENURE2_T3106500,
         AGE_START_JOB3_2010 = AGEATINT_R3108700 - TENURE3_T3106600,
         AGE_START_JOB4_2010 = AGEATINT_R3108700 - TENURE4_T3106700,
         AGE_START_JOB5_2010 = AGEATINT_R3108700 - TENURE5_T3106800)

trainData79 <- trainData79 %>%
  mutate(MEAN_AGE_JOB1_2010 = (AGEATINT_R3108700 + AGE_START_JOB1_2010) / 2,
         MEAN_AGE_JOB2_2010 = (AGEATINT_R3108700 + AGE_START_JOB2_2010) / 2,
         MEAN_AGE_JOB3_2010 = (AGEATINT_R3108700 + AGE_START_JOB3_2010) / 2,
         MEAN_AGE_JOB4_2010 = (AGEATINT_R3108700 + AGE_START_JOB4_2010) / 2,
         MEAN_AGE_JOB5_2010 = (AGEATINT_R3108700 + AGE_START_JOB5_2010) / 2)

# 2012
trainData79 <- trainData79 %>% 
  mutate(AGE_START_JOB1_2012 = AGEATINT_R4113200 - TENURE1_T4110400,
         AGE_START_JOB2_2012 = AGEATINT_R4113200 - TENURE2_T4110500,
         AGE_START_JOB3_2012 = AGEATINT_R4113200 - TENURE3_T4110600,
         AGE_START_JOB4_2012 = AGEATINT_R4113200 - TENURE4_T4110700,
         AGE_START_JOB5_2012 = AGEATINT_R4113200 - TENURE5_T4110800)

trainData79 <- trainData79 %>%
  mutate(MEAN_AGE_JOB1_2012 = (AGEATINT_R4113200 + AGE_START_JOB1_2012) / 2,
         MEAN_AGE_JOB2_2012 = (AGEATINT_R4113200 + AGE_START_JOB2_2012) / 2,
         MEAN_AGE_JOB3_2012 = (AGEATINT_R4113200 + AGE_START_JOB3_2012) / 2,
         MEAN_AGE_JOB4_2012 = (AGEATINT_R4113200 + AGE_START_JOB4_2012) / 2,
         MEAN_AGE_JOB5_2012 = (AGEATINT_R4113200 + AGE_START_JOB5_2012) / 2)

# 2014
trainData79 <- trainData79 %>% 
  mutate(AGE_START_JOB1_2014 = AGEATINT_R5023600 - TENURE1_T5019200,
         AGE_START_JOB2_2014 = AGEATINT_R5023600 - TENURE2_T5019300,
         AGE_START_JOB3_2014 = AGEATINT_R5023600 - TENURE3_T5019400,
         AGE_START_JOB4_2014 = AGEATINT_R5023600 - TENURE4_T5019500,
         AGE_START_JOB5_2014 = AGEATINT_R5023600 - TENURE5_T5019600)

trainData79 <- trainData79 %>%
  mutate(MEAN_AGE_JOB1_2014 = (AGEATINT_R5023600 + AGE_START_JOB1_2014) / 2,
         MEAN_AGE_JOB2_2014 = (AGEATINT_R5023600 + AGE_START_JOB2_2014) / 2,
         MEAN_AGE_JOB3_2014 = (AGEATINT_R5023600 + AGE_START_JOB3_2014) / 2,
         MEAN_AGE_JOB4_2014 = (AGEATINT_R5023600 + AGE_START_JOB4_2014) / 2,
         MEAN_AGE_JOB5_2014 = (AGEATINT_R5023600 + AGE_START_JOB5_2014) / 2)

# 2016
trainData79 <- trainData79 %>% 
  mutate(AGE_START_JOB1_2016 = AGEATINT_R5771500 - TENURE1_T5768100,
         AGE_START_JOB2_2016 = AGEATINT_R5771500 - TENURE2_T5768200,
         AGE_START_JOB3_2016 = AGEATINT_R5771500 - TENURE3_T5768300,
         AGE_START_JOB4_2016 = AGEATINT_R5771500 - TENURE4_T5768400,
         AGE_START_JOB5_2016 = AGEATINT_R5771500 - TENURE5_T5768500)

trainData79 <- trainData79 %>%
  mutate(MEAN_AGE_JOB1_2016 = (AGEATINT_R5771500 + AGE_START_JOB1_2016) / 2,
         MEAN_AGE_JOB2_2016 = (AGEATINT_R5771500 + AGE_START_JOB2_2016) / 2,

...
original_data_97 <- read_csv("data/fulldata_97.csv")
names_dictionary_97 <- read.csv("data/dictionary_97.csv", sep = ";")
...
data_mutations_97 <- columnar_data_97 %>% 
  ...
  dplyr::mutate(
    ...
    hourly_pay = log(((hourly_pay/100) * cpi) + 1),
...
save(final_data_97, file = "data/prepped_97_full.RData")